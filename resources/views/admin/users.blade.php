                    ...
                    <tbody>
                        @foreach ($user as $users)
                            ...
                            <div class="modal fade" id="edit-modal{{ $users->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-top" role="document">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.edit_users') }}" method="POST"
                                            ...
                                            <div class="block block-themed block-transparent mb-0">
                                                ...
                                                <div class="block-content">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="email" id="message-email"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" id="example-select-custom"
                                                            name="role">
                            ...
                            <div class="modal fade" id="delete-modal{{ $users->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-top" role="document">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.delete_users') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="block block-themed block-transparent mb-0">
                                                ...
                                                <div class="block-content block-content-full text-right border-top">
                                                    <button type="button" class="btn btn-sm btn-outline-dangerr mr-2"
                                                        data-dismiss="modal">Cancel</button>

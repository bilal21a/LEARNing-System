                    ...
                    <tbody>
                        @foreach ($rp as $key => $role)
                                                ...
                                                <div class="block-content">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="role_name"
                                                            id="message-email" value="{{ $role->name }}">
                                                        <input class="form-control" type="hidden" name="role_id"
                                                            value="{{ $role->id }}">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <label for="example-text-input"
                                                                class="main_label">Permissions</label>
                                                            <select class="js-select2 form-control "
                                                                id="edit_perm{{ $role->id }}" name="edit_perm[]"
                                                                style="width: 100%;" data-placeholder="Choose Skills"
                                                                multiple>
                                                                @php
                            ...
                            <div class="modal fade" id="delete-modal{{ $role->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-top" role="document">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.delete_role') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="block block-themed block-transparent mb-0">
                                                ...
                                                <input class="form-control" type="hidden" id="message-id" name="role_id"
                                                    value="{{ $role->id }}">
                ...
                <form action="{{ route('admin.add_role') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <div class="form-group">
                                <label for="message-email">Name</label>
                                <input class="form-control" type="text" id="message-email" value="" name="role_name"
                                    placeholder="Role Name">
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <label for="example-text-input" class="main_label">Permissions</label>
                                    <select class="js-select2 form-control " id="add_perm" name="add_perm[]"
                                        style="width: 100%;" data-placeholder="Choose Skills" multiple>
                                        @php
                                            $allperms = Spatie\Permission\Models\Permission::get();
                                        @endphp
                                        @foreach ($allperms as $allperm)

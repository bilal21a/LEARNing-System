             ...
             <div class="dropdown d-inline-block ml-2">
                 <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown"
                     ...
                     @if ($find->profile_pic == null)
                         <img class="rounded" src="{{ asset('adminDefault.jpg') }}" alt="Header Avatar"
                             style="width: 18px;">
                     @else
                         <img class="rounded" src="{{ asset('img/profile_image/' . $find->profile_pic) }}"
                     ...
                     <div class="p-3 text-center bg-primary">
                         @if ($find->profile_pic == null)
                             <img class="img-avatar img-avatar48 img-avatar-thumb"
                                 src="{{ asset('adminDefault.jpg') }}">
                         @else
                             <img class="img-avatar img-avatar48 img-avatar-thumb"
                                 src="{{ asset('img/profile_image/' . $find->profile_pic) }}">
                         @endif
                         ...
                         <li>
                             <a class="text-dark media py-2" href="javascript:void(0)">
                                 ...
                                 <div class="media-body pr-2">
                                     <div class="font-w600"> Posted a New Post</div>
                                     <small class="text-muted">22-22-22</small>
                                 </div>
                             </a>
                         </li>

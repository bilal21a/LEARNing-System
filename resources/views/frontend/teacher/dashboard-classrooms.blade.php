...
<!-- Mirrored from demo.afracode.com/eduline/teacher/dashboard-classrooms.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Oct 2021 10:13:46 GMT -->
<head>
    <title>Eduline</title>
    <meta charset="UTF-8" />
        ...
        <div class="sidenav-body">
            <div class="sidenav-body-inner">
                <div class="sidenav-links">
                    <a href="http://../page-login.html" class="button button-md button-block button-line-primary">
                        <span class="text">Sign In</span>
                    </a>
                    <a href="http://../page-register.html" class="button button-md button-block button-primary">
                        <span class="text">Sign Up</span>
                    </a>
                </div>
                <ul>

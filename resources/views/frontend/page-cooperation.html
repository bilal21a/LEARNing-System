...
<body>
    ...
    <!--/-->
    <!--Header-->
    <header class="app-header app-header-1 glass">
        <div class="container">
            ...
            <a href="page-cooperation.html">
                ...
                <div class="header-logo">
                    <a href="home.html" class="primary-logo">
                        <span class="text-1">Edu</span>
                        <span class="text-2"></span>
                    </a>
                </div>
                <div class="header-links">
                    <a href="page-login.html" class="button button-md button-light button-line-primary">
                        <span class="title">Sign In</span>
                    </a>
                    <a href="page-register.html" class="button button-md button-primary">
...
<div class="page page-cooperation">
    <!--Hero-->
    <section class="section section-hero section-hero-4 overlay-color overlay-image" style="background-image: url(assets/images/hero/hero-apply.jpg);">
        <span class="bg-color bg-dark-side"></span>
        <div class="display-center">
            <div class="container">
                <div class="hero-content">
                    <h1 class="text-light">Apply to teach Anytime.<br />Earn money. Anywhere.</h1>
                    ...
                    <a href="page-register.html" class="button button-md button-primary">
                        ...
                        <span class="text text-light">Apply Now!</span>
                    </a>
                    <a href="page-register.html" class="button button-md button-secondary">
                        <span class="wave-hover"></span>
                        <span class="text text-light">Read More</span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <!--/-->
    <!--Features-->
    <section class="section section-features section-features-2">
        ...
        <div class="display-spacing">
            <div class="container">
                <header class="el-heading center">
                    <h2>Learn a new language with an online tutor</h2>
                ...
                <div class="row mb--45">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="item">
                            <div class="icon">
                                <img src="assets/images/icons/feature-1.svg" alt="features">
                            </div>
                            <div class="details">
                                <h3>Earn money</h3>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="item">
                            <div class="icon">
                                <img src="assets/images/icons/feature-2.svg" alt="features">
                            </div>
                            <div class="details">
                                <h3>Teach anytime</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do.</p>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="item">
                            <div class="icon">
                                <img src="assets/images/icons/feature-3.svg" alt="features">
                            </div>
                            <div class="details">
                                <h3>Work anywhere</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do.</p>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="item">
                            <div class="icon">
                                <img src="assets/images/icons/feature-4.svg" alt="features">
                            </div>
                            <div class="details">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="item">
                            <div class="icon">
                                <img src="assets/images/icons/feature-5.svg" alt="features">
                            </div>
                            <div class="details">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="item">
                            <div class="icon">
                                <img src="assets/images/icons/feature-6.svg" alt="features">
                            </div>
                            <div class="details">
                                <h3>Flexibility</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do.</p>
    ...
    <!--/-->
    <!--Call-To-Action-->
    <div class="section el-cta el-cta-1 overlay-color bg-primary">
        <div class="display-center">
            <div class="container">
                <div class="heading">
                    <h2>Apply to teach now.<br />Earn money. Anywhere.</h2>
                    ...
                    <a href="page-cooperation.html" class="button button-md button-light">
                        <span class="wave-hover"></span>
                ...
                <div class="items mb--15">
                    ...
                    <div class="el-accordion">
                        <div class="el-accordion-head">
                            <div class="inner d-flex align-items-center">
                                ...
                                <div class="accordion-title">
                                    <h3>How do I apply to teach on Eduline?</h3>
                                </div>
                        ...
                        <div class="el-accordion-body">
                            <p>Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi.

                                Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi.</p>
                        </div>
                    </div>
                    <!--/-->
                    <!--Accordion-->
                    ...
                    <div class="el-accordion">
                        <div class="el-accordion-head">
                            <div class="inner d-flex align-items-center">
                                ...
                                <div class="accordion-title">
                                    <h3>Can I teach more than one language?</h3>
                                </div>
                                <div class="accordion-arrow">
                                    <div class="display-center">
                                        <span class="fa fa-angle-down"></span>
                    ...
                    <div class="el-accordion">
                        <div class="el-accordion-head">
                            <div class="inner d-flex align-items-center">
                                ...
                                <div class="accordion-title">
                                    <h3>How much can I expect to earn from private lessons?</h3>
                                </div>
                                <div class="accordion-arrow">
                                    <div class="display-center">
                                        <span class="fa fa-angle-down"></span>
                    ...
                    <div class="el-accordion">
                        <div class="el-accordion-head">
                            <div class="inner d-flex align-items-center">
                                ...
                                <div class="accordion-title">
                                    <h3>As a teacher, how do I receive payment?</h3>
                                </div>
                                <div class="accordion-arrow">
                                    <div class="display-center">
                                        <span class="fa fa-angle-down"></span>
        ...
        <div class="container">
            ...
            <div class="row mb--30">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-4">
                    <div class="el-card el-card-post">
                        ...
                        <div class="card-details">
                            <h3>
                                <a href="page-single-post.html">Blogging for business? Here’s everything you need to know.</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                            <div class="post-meta post-meta-view">
                                <span>33</span>
                                <i class="fa fa-eye"></i>
                            </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-4">
                    <div class="el-card el-card-post">
                        <div class="card-image">
                            <a href="page-single-post.html">
                                <img src="assets/images/blog/2.jpg" alt="Post Thumbnail" />
                            </a>
                        </div>
                        <div class="card-details">
                            <h3>
                                <a href="page-single-post.html">The benefits of blogging for business and marketing.</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                            <div class="post-meta post-meta-view">
                                <span>33</span>
                ...
                <div class="col 12 col-sm-12 col-md-12 col-lg-4">
                    <div class="el-card el-card-post">
                        <div class="card-image">
                            <a href="page-single-post.html">
                                <img src="assets/images/blog/3.jpg" alt="Post Thumbnail" />
                            </a>
                        </div>
                        <div class="card-details">
                            <h3>
                                <a href="page-single-post.html">5 powerful benefits of blogging for your small business.</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
                            <div class="post-meta post-meta-view">
                                <span>33</span>
            ...
            <div class="el-read-more div-center text-center">
                <a href="page-blog.html" class="el-popover">

            ...
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-left border-success border-4x"
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="font-size-h2 font-w400 text-dark">56</div>
                    </div>
                </a>
            </div>
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                <a class="block block-rounded block-link-pop border-left border-success border-4x"
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <div class="font-size-h2 font-w400 text-dark">90</div>
                    </div>
                </a>
            </div>
            <div class="col-6 col-md-3 col-lg-6 col-xl-3">
                                    ...
                                    @foreach ($user_all as $users)
                                        <tr>
                                            <td class="d-none d-sm-table-cell text-center">
                                                @if ($users->profile_pic)
                                                    <img class="img-avatar img-avatar48"
                                                        src="{{ asset('img/profile_image/' . $users->profile_pic) }}"
                                                        alt="">
                                                @else
                                                    <img class="img-avatar img-avatar48"
                                            ...
                                            <td class="d-none d-sm-table-cell text-center">
                                                ...
                                                @endphp
                                                @if (isset($my_role[0]))
                                                    <a class="link-fx font-w600 badge badge-info"
                                                        href="javascript:void(0)">{{ $my_role[0] }}</a>
                                                @else
                                                    <a class="link-fx font-w600 badge badge-danger"
                                                        href="javascript:void(0)">Guest</a>
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                                        data-target="#accept-modal{{ $users->id }}">
                                                        <i class="fa fa-fw fa-check"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal"
                                                        data-target="#reject-modal{{ $users->id }}">
                                        ...
                                        <!-- Accept Modal -->
                                        <div class="modal fade" id="accept-modal{{ $users->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="one-inbox-new-message" aria-hidden="true">
                                                    ...
                                                    <div class="block block-themed block-transparent mb-0">
                                                        <div class="block-header bg-success">
                                                            ...
                                                            <input type="hidden" class="form-control"
                                                                id="example-text-input" name="id" placeholder=""
                                                                value="{{ $users->id }}">
                                                            <div class="block-options">
                                                        ...
                                                        <input class="form-control" type="hidden" id="message-id"
                                                            name="id" value="">
                                                        <div class="block-content block-content-full text-right border-top">
                                                            <button type="button"
                                                                class="btn btn-sm btn-outline-success mr-2"
                                                                data-dismiss="modal">Cancel</button>
                                                            <a href="{{ url('admin/user_accept/' . $users->id) }}"><button
                                                                    type="button" class="btn btn-sm btn-success"><i
                                                                        class="fa fa-fw fa-check mr-1"></i>
                                                                    Accept</button></a>
                                                        </div>
                                                    </div>
                                                    {{-- </form> --}}
                                        ...
                                        <!-- END Accept Modal -->
                                        <!-- Reject Modal -->
                                        <div class="modal fade" id="reject-modal{{ $users->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="one-inbox-new-message" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="block block-themed block-transparent mb-0">
                                                        ...
                                                        <div class="block-content block-content-full text-right border-top">
                                                            <button type="button" class="btn btn-sm btn-outline-danger mr-2"
                                                                data-dismiss="modal">Cancel</button>
                                                            <a href="{{ url('admin/user_reject/' . $users->id) }}"><button
                                    ...
                                    @foreach ($post_all as $post)
                                        <tr>
                                            <td class="d-none d-sm-table-cell text- ">
                                                <div class="mt-2 font-w600 three_dots s-ttl" data-toggle="popover"
                                                    data-html="true" data-placement="top" data-content="<div class='text-center'>
                                                                           <p>{{ $post->title }} ​</p></div">
                                                    {{ $post->title }}
                                                </div>
                                            </td>
                                            <td>
                                                <span
                                                    class="font-w600">{{ App\User::find($post->created_by)['name'] }}</span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-sm btn-success"
                                                        data-toggle="modal" data-target="#accept-modal{{ $post->id }}">
                                                        <i class="fa fa-fw fa-check"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal"
                                                        data-target="#reject-modal{{ $post->id }}">
                                                        <i class="fa fa-fw fa-times"></i>
                                                    </button>
                                            </td>
                                        </tr>
                                        <!-- Accept Modal -->
                                        <div class="modal fade" id="accept-modal{{ $post->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="one-inbox-new-message" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    <div class="block block-themed block-transparent mb-0">
                                                        ...
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-sm btn-outline-success mr-2"
                                                                data-dismiss="modal">Cancel</button>
                                                            <a href="{{ url('admin/post_accept/' . $post->id) }}"><button
                                                                    type="button" class="btn btn-sm btn-success"><i
                                                                        class="fa fa-fw fa-check mr-1"></i>
                                                                    Accept</button></a>
                                                        </div>
                                        ...
                                        <!-- END Accept Modal -->
                                        <!-- Reject Modal -->
                                        <div class="modal fade" id="reject-modal{{ $post->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="one-inbox-new-message" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-top" role="document">
                                                <div class="modal-content">
                                                    <div class="block block-themed block-transparent mb-0">
                                                        ...
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                data-dismiss="modal">Cancel</button>
                                                            <a href="{{ url('admin/post_reject/' . $post->id) }}"><button
                                                                    type="button" class="btn btn-sm btn-danger"><i
